...
- Fixed: Clicking or dragging the scrollbar to jump around a large list now lands with full rows of cards above and below, and dragging to the very top and releasing no longer leaves a blank screen — instead of showing a clipped last row or empty space until you nudge the scroll
