...
- Changed: Paging deep into a large list no longer keeps every page you scrolled past in memory — infinite scroll now keeps a few pages buffered and re-fetches earlier pages from the server as you scroll back up, instead of growing memory without bound
