...
$caPaths['application-feed']                    = "https://assets.ca.unraid.net/feed/applicationFeed.json";
$caPaths['application-feed-last-updated']       = "https://assets.ca.unraid.net/feed/applicationFeed-lastUpdated.json";
